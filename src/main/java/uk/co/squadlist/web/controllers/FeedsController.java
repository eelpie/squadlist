...
public class FeedsController {
    ...
    private final DefaultApi squadlistSwaggerApiClient;
    ...
    public FeedsController(InstanceConfig instanceConfig, UrlBuilder urlBuilder,
        ...
        this.squadlistSwaggerApiClient = squadlistApiFactory.createSwaggerClient();
    }
    ...
    public void outingsIcal(@RequestParam(value = "user", required = false) String user, HttpServletResponse response) throws Exception {
        ...
        final String calendar = squadlistSwaggerApiClient.getMemberOutingsCalendar(member.getId(),
