...
public class BritishRowingTest {
	...
	public void effectiveAgeForMastersIsTheAgeTheyWouldReachBy31DecOfTheCurrentYear() {
		assertEquals(49, britishRowing.getEffectiveAge(new DateTime(1975, 12, 13, 0, 0, 0, 0)));
		assertEquals(49, britishRowing.getEffectiveAge(new DateTime(1975, 1, 1, 0, 0, 0, 0)));
		assertEquals(49, britishRowing.getEffectiveAge(new DateTime(1975, 12, 31, 0, 0, 0, 0)));
	}
